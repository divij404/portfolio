  ...
  return (
    <div ref={containerRef} className="bg-black text-white">
          ...
          >
            ...
            <div className="max-w-2xl">
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Passionate about technology and learning. Currently exploring
                web development, data structures, and algorithms while pursuing
          ...
          <div className="flex flex-col md:flex-row gap-16">
            ...
            >
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  I'm a first-year undergraduate student at University of
                  Wisconsin-Madison studying Computer Science. My journey in
                  technology began with building simple websites, and I've been
                  passionate about creating digital experiences ever since.
                </p>
                <p>
                  Currently, I'm focused on building a strong foundation in
                  programming fundamentals, data structures, and algorithms. I'm
                  also exploring web development and machine learning.
                </p>
      ...
      <section
        id="skills"
        ref={skillsRef}
        className="py-32 px-6 bg-black/80 relative"
      >
        <div className="max-w-5xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="space-y-8">
                <p className="text-gray-300">
                  I'm always open to connecting with fellow students, mentors,
                  and technology enthusiasts. Whether you have a question, want
                  to collaborate on a project, or just want to say hi, I'd love
                  to hear from you!
                </p>
